 ...
 */
@WebServlet("/AjouterFiliereServlet")
public class AjouterFiliereServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd=request.getRequestDispatcher("WEB-INF/ajouterfilier.jsp");  
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Filiere filiere = new Filiere(0,intitule);
		System.out.println(filiere);
		new FiliereDAO().addFiliere(filiere);
